...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/hugjobk/checkers/checkers/can_play_move/{gameIndex}/{player}/{fromX}/{fromY}/{toX}/{toY}
   */
  queryCanPlayMove = (
    gameIndex: string,
    player: string,
    ...
    this.request<CheckersQueryCanPlayMoveResponse, RpcStatus>({
      path: `/hugjobk/checkers/checkers/can_play_move/${gameIndex}/${player}/${fromX}/${fromY}/${toX}/${toY}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/hugjobk/checkers/checkers/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<CheckersQueryParamsResponse, RpcStatus>({
      path: `/hugjobk/checkers/checkers/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/hugjobk/checkers/checkers/player_info
   */
  queryPlayerInfoAll = (
    query?: {
    ...
    this.request<CheckersQueryAllPlayerInfoResponse, RpcStatus>({
      path: `/hugjobk/checkers/checkers/player_info`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/hugjobk/checkers/checkers/stored_game
   */
  queryStoredGameAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<CheckersQueryAllStoredGameResponse, RpcStatus>({
      path: `/hugjobk/checkers/checkers/stored_game`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
