...
export interface CheckersleaderboardLeaderboard {
 ...
 */
export interface CheckersleaderboardParams {
  /** @format uint64 */
  length?: string;
}

export interface LeaderboardQueryGetLeaderboardResponse {
  Leaderboard?: CheckersleaderboardLeaderboard;
}
...
export interface LeaderboardQueryParamsResponse {
  ...
  params?: CheckersleaderboardParams;
}
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/hugjobk/checkers/leaderboard/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<LeaderboardQueryParamsResponse, RpcStatus>({
      path: `/hugjobk/checkers/leaderboard/params`,
      method: "GET",
      format: "json",
      ...params,
    });
