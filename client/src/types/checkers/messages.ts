...
export const typeUrlMsgCreateGame = "/hugjobk.checkers.checkers.MsgCreateGame";
export const typeUrlMsgCreateGameResponse =
  "/hugjobk.checkers.checkers.MsgCreateGameResponse";
export const typeUrlMsgPlayMove = "/hugjobk.checkers.checkers.MsgPlayMove";
export const typeUrlMsgPlayMoveResponse =
  "/hugjobk.checkers.checkers.MsgPlayMoveResponse";
...
export interface MsgCreateGameEncodeObject extends EncodeObject {
  readonly typeUrl: "/hugjobk.checkers.checkers.MsgCreateGame";
...
export interface MsgCreateGameResponseEncodeObject extends EncodeObject {
  readonly typeUrl: "/hugjobk.checkers.checkers.MsgCreateGameResponse";
...
export interface MsgPlayMoveEncodeObject extends EncodeObject {
  readonly typeUrl: "/hugjobk.checkers.checkers.MsgPlayMove";
...
export interface MsgPlayMoveResponseEncodeObject extends EncodeObject {
  readonly typeUrl: "/hugjobk.checkers.checkers.MsgPlayMoveResponse";
