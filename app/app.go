...
import (
	...
	"github.com/hugjobk/checkers/docs"
...
func NewApp(
	...
	app.configurator.RegisterMigration(monitoringptypes.ModuleName, cv2types.ConsensusVersion, func(ctx sdk.Context) error { return nil })
